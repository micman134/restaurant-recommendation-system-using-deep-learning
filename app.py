this is my code: import streamlit as st
import requests
import pandas as pd
...
# Footer
st.markdown('<div class="custom-footer">© 2025 AI Restaurant Recommender</div>', unsafe_allow_html=True). i am getting this message no matter what i put "❌ No restaurants found. Try different search terms."
